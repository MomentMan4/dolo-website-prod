...
export function StartPage() {
  ...
  useEffect(() => {
    ...
    // Add plan price
    if (selectedPlan === "launch") oneTimePrice += plans.launch
    else if (selectedPlan === "grow") oneTimePrice += plans.grow
    else if (selectedPlan === "elevate") oneTimePrice += plans.elevate
          ...
          <div className="mb-12">
            ...
            <motion.div className="grid gap-6 md:grid-cols-3" variants={container} initial="hidden" animate="show">
              ...
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
                animate={
                  selectedPlan !== "grow" && !selectedPlan
                    ? {
                        boxShadow: [
              ...
              <motion.div
                className={`relative cursor-pointer rounded-xl border-2 p-6 transition-all ${
                  selectedPlan === "elevate"
                    ? "border-orange bg-orange/5"
                    : "border-gray-200 bg-white hover:border-gray-300"
                }`}
                variants={item}
                onClick={() => setSelectedPlan("elevate")}
                whileHover={{ y: -5 }}
                whileTap={{ scale: 0.98 }}
              >
                {selectedPlan === "elevate" && (
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-2">
                  ...
                  >
                    <div className="flex flex-col space-y-2">
                      ...
                      <p className="text-xs text-gray-600">
                        Improve local visibility and show up in Google searches and maps with a professionally optimized
                  ...
                  >
                    <div className="flex flex-col space-y-2">
                      ...
                      <p className="text-xs text-gray-600">
                        Make your site inclusive and compliant with WCAG standards to reach all potential customers and
                        reduce legal risks.
                      </p>
                    </div>
                  </motion.div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <motion.span
                        ...
                        transition={{ duration: 0.3 }}
                      >
                        ${selectedPlan === "launch" ? "499.99" : selectedPlan === "grow" ? "849.99" : "1199.99"}
                      </motion.span>
                    </div>
                    ...
                    {rushDelivery && (
                      <div className="flex justify-between">
                        ...
                        <motion.span
                          ...
                          transition={{ duration: 0.3 }}
                        >
                          ${(selectedPlan === "launch" ? 99.99 : selectedPlan === "grow" ? 169.99 : 239.99).toFixed(2)}
                        </motion.span>
                      </div>
                    )}
                ...
                <div className="rounded-xl bg-white p-6 shadow-md">
                  ...
                  <form className="space-y-6">
                    ...
                    >
                      ...
                      <Input id="target-audience" className="mt-1" required />
                    </motion.div>
                    ...
                    >
                      ...
                      <Textarea id="products-services" className="mt-1" required />
                    </motion.div>
                    ...
                    >
                      ...
                      <div className="mt-2 flex space-x-4">
                        <label className="flex items-center">
                          <input type="radio" name="branding-guidelines" className="h-4 w-4 text-orange" />
                          <span className="ml-2 text-sm">Yes</span>
                        </label>
                        <label className="flex items-center">
                          <input type="radio" name="branding-guidelines" className="h-4 w-4 text-orange" />
                    ...
                    >
                      ...
                      <Textarea id="competitors" className="mt-1" />
                    </motion.div>
                    ...
                    >
                      <Label htmlFor="updates">
                        How frequently will the website need to be updated, and who will be responsible for making those
                        updates?
                      </Label>
                      <Textarea id="updates" className="mt-1" />
                    </motion.div>
                    ...
                    >
                      ...
                      <Textarea id="keywords" className="mt-1" />
                    </motion.div>
                    ...
                    >
                      ...
                      <Input id="files" type="file" className="mt-1" multiple />
                    </motion.div>
